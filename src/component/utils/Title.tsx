...
const Title = (props: TitleTypeProps) => {
  ...
  return (
    <Component
      className={
        "inline-block bg-gradient-to-r from-cyan-300/60 via-cyan-300/80 to-sky-300/80 bg-clip-text pb-2 text-xl font-semibold text-transparent sm:pb-4 sm:text-2xl lg:pb-6 lg:xl:text-3xl"
      }
    >
      {children}
    </Component>
