    ...
    <ul className="space-y-4 text-base sm:text-lg md:text-xl xl:text-2xl">
      ...
      <li>
        <div className="flex flex-wrap">
          <p className="mr-2 font-normal">
            2.
            獎項方面，除原有針對計算流力的獎項(由航太學會頒發)外，亦將新增兩個針對一般流力領域(不限實驗，理論或計算)的論文獎項。原有計算流力的獎項，前三名亦提供獎金，分別為新台幣10,000元（第一名）、5,000元（第二名）、及3,000元（第三名）。而本次額外新增的獎項，亦提供獎金，為新台幣10,000元（第一名）、及5,000（第二名），促進活動推廣。
          </p>
        </div>
      </li>
      <li>
