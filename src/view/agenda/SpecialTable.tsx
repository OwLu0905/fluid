    ...
    <div className="flex border-b-2 border-gray-600/30  text-xl xl:text-2xl">
      <div className="flex w-1/2">
        ...
        <div className="flex grow">
          ...
          {/* stable */}
          {/* <div className="md:text-md my-6 mx-2 flex max-w-[6rem] shrink items-center rounded-xl bg-gradient-to-b from-stone-300/70 via-stone-300/80 to-zinc-300/60 px-2 py-1 text-sm text-stone-800/80 shadow-md shadow-zinc-500/60 sm:mx-4 sm:max-w-[6rem] sm:text-base md:max-w-[6rem] lg:max-w-[6rem] lg:text-lg xl:max-w-[8rem] xl:px-4 xl:text-2xl 2xl:max-w-[10rem]">
            流體力學學會會員大會暨年輕學者獎頒獎
          </div> */}
